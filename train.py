...
from data import get_cifar100_loaders, get_sparse_loaders
...
def main():
    ...
    # FINE-TUNING SETUP
    if config.finetuning_method == "dense":
    ...
    if ckpt_path.split("/")[-1].startswith("best"):
        best = True
    else:
        best = False
    ...
    for epoch in range(starting_epoch, config.epochs):
        ...
        wandb.log({
            "lr": scheduler.get_last_lr()[0] if scheduler is not None else config.learning_rate,
